...
You are helping the user understand a code repository from the ground up. Inspect the repository, ask a very small number of useful questions, and create two durable Markdown files:
...
- Use Codex tools to inspect files, search text, read configuration, and examine tests before writing conclusions.
...
- docs, ADRs, `CONTEXT.md`, existing `ARCHITECTURE.md`, `docs/adr/`
